...
let products = [
    {
        ...
        details: 'عسل سدر جبلي طبيعي من أفضل المناحل في جبال السروات، يتميز بلونه الذهبي الداكن ورائحته الزكية وطعمه اللذيذ.',
        benefits: [
            'يقوي جهاز المناعة',
        ...
        price: 120,
        badge: 'best-seller',
        imageData: 'https://images.unsplash.com/photo-1558655146-d09347e92766?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1064&q=80',
        images: [],
        options: []
    },
    {
        ...
        description: 'عسل طبيعي من رحيق الزهور البرية',
        details: 'عسل زهور برية طبيعي يتم جمعه من رحيق الزهور البرية في المناطق الجبلية، يتميز بلونه الفاتح وطعمه المعتدل.',
        benefits: [
        ...
        price: 90,
        badge: 'new',
        imageData: 'https://images.unsplash.com/photo-1587049352851-8d4e89133924?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=987&q=80',
        images: [],
        options: []
    },
    {
        id: '3',
        name: 'عسل المانوكا',
        description: 'عسل مانوكا النيوزيلندي الأصلي',
        details: 'عسل مانوكا النيوزيلندي الأصلي ذو الخصائص العلاجية الفريدة، يتميز بقوامه الكثيف ولونه الداكن وطعمه القوي.',
        benefits: [
            'خصائص مضادة للبكتيريا',
            'يساعد في علاج الجروح والحروق',
    ...
    {
        id: '4',
        name: 'صندوق هدايا العسل',
        description: 'صندوق هدايا فاخر يحتوي على 3 أنواع من العسل',
        details: 'صندوق هدايا فاخر مصنوع من الخشب الطبيعي يحتوي على 3 أنواع مميزة من العسل (سدر، زهور برية، مانوكا) مع ملعقة خشبية.',
        benefits: [
            'هدية مثالية للأحباب',
            'تغليف فاخر وجذاب',
            'يشمل أفضل أنواع العسل',
            'مناسب لكل المناسبات'
        ],
        price: 350,
        badge: 'offer',
        imageData: 'https://images.unsplash.com/photo-1558655146-6c222e04b7bf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=987&q=80',
        images: [],
        options: []
    }
];
...
// تحميل كلمة المرور من localStorage أو استخدام الافتراضية
function getStoredPassword() {
    const storedHash = localStorage.getItem('admin_password_hash');
    return storedHash || hashPassword(DEFAULT_PASSWORD);
}

// حفظ كلمة المرور المشفرة في localStorage
...
function hashPassword(password) {
    // هذا مثال بسيط للتشفير، في تطبيق حقيقي استخدم algo مثل SHA-256
    let hash = 0;
...
addProductForm.addEventListener('submit', function(e) {
    ...
    mainImageReader.onload = function(e) {
        ...
        Promise.all(additionalImagesPromises).then(imagesBase64 => {
            const newProduct = {
                id: id,
                name: name,
...
function sendOrderViaWhatsApp() {
    ...
    // تكوين رسالة الطلب
    let message = 'السلام عليكم، أريد طلب المنتجات التالية من مركز النحلة:\n\n';
    ...
    // تشفير الرسالة لتكون جزءًا من الرابط
    const encodedMessage = encodeURIComponent(message);
    const whatsappUrl = `https://wa.me/967771643727?text=${encodedMessage}`;
